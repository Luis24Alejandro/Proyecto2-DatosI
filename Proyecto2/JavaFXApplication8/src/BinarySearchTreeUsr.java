...
public class BinarySearchTreeUsr {

    private Node root;
    

    public BinarySearchTreeUsr() {
        root = null;
        try {
            File file = new File("src/datos/usuarios.xml");
    ...
    public void toXml() {
        try {
            ...
            XMLStreamWriter writer = factory.createXMLStreamWriter(new FileOutputStream(new File("src/datos/usuarios.xml")));
...
public void delete(String nombreUsuario) {
    ...
    Node node = search(root, nombreUsuario);
    if (node == null) {
...
private Node deleteRecursive(Node current, String nombreUsuario) {
    if (current == null) {
        return null;
    }
...
private Usuario findSmallestValue(Node root) {
    return root.left == null ? root.usuario : findSmallestValue(root.left);
}

private Node search(Node node, String nombreUsuario) {
