...
public class LoginRegister extends Application {
    ...
    private AppCliente buscaminas;
    private GameMenu gameMenu;

    private Stage primaryStage;
    private Image img = new Image("file:/C:/Users/ulise/Desktop/TEC/Algoritmos y estructura de datos I/Proyecto2/JavaFXApplication8/src/images/FondoLogin.png");
    ...
    private class GameMenu extends Parent {
        ...
        public GameMenu() {
            ...
            button2 = new Button("SING UP");
            button2.setFont(Font.font("Roboto", FontWeight.BOLD, 16));

            button2.setStyle("-fx-background-color: #333366; -fx-text-fill: white; -fx-border-style: none;");
            button1.setStyle("-fx-background-color: transparent; -fx-text-fill: black; -fx-border-style: none;");

            HBox hboxx = new HBox(button1, button2);
            hboxx.setAlignment(Pos.CENTER);
            hboxx.setSpacing(0);
            hboxx.setTranslateX(50);
            ...
            MenuButton btnSingUp = new MenuButton("   SING UP", 90, 30, 10);
            ...
            button1.setOnAction(event -> {
                button2.setStyle("-fx-background-color: #333366; -fx-text-fill: black; -fx-border-style: none;");
                button1.setStyle("-fx-background-color: transparent; -fx-text-fill: white; -fx-border-style: none;");
            ...
            button2.setOnAction(event -> {
                button1.setStyle("-fx-background-color: #333366; -fx-text-fill: black; -fx-border-style: none;");
                button2.setStyle("-fx-background-color: transparent; -fx-text-fill: white; -fx-border-style: none;");
            ...
            HBox hbox2 = new HBox(btnSingUp);
            menu0.getChildren().addAll(labelUsuario, campoUsuario, labelPassword, campoPassword, hbox, labelRespuesta);
            menu1.getChildren().addAll(labelUsuarioReg, campoUsuarioReg, labelPasswordReg, campoPasswordReg, hbox2,labelRespuesta2);
        ...
        private void enviarCredenciales() {
            try {
                ...
                Mensaje mensaje = new Mensaje("login", usuario, password,"","");
        ...
        private void enviarRegistro() throws IOException, ClassNotFoundException {
            ...
            // Crear objeto Mensaje con la acción "register" y los datos de usuario y contraseña
            //Credenciales credenciales = new Credenciales(usuario, password);
            Mensaje mensaje = new Mensaje("register", usuario, password,"","");
            ...
            labelRespuesta2.setText(respuesta);
